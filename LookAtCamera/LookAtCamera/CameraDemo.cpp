...
CameraDemo::CameraDemo() : solidColorVS_( 0 ) , solidColorPS_( 0 ) , vertexBuffer_( 0 ) , 
	inputLayout_( 0 ) , indexBuffer_( 0 ) , colorMap_( 0 ) , colorMapSampler_( 0 ) , viewCB_( 0 ) ,
...
void CameraDemo :: Render()
{
	...
	d3dContext_ ->UpdateSubresource( worldCB_ , 0 , 0 , &worldMatrix , 0 , 0 );
	...
	d3dContext_ ->VSSetConstantBuffers( 2 , 1 , &worldCB_ );
