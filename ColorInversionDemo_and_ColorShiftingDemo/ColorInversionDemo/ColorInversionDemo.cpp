...
ColorInversionDemo :: ColorInversionDemo() : effect_( 0 ) , inputLayout_( 0 ) , vertexBuffer_( 0 ) , 
	indexBuffer_( 0 ) , colorMap_( 0 ) , colorMapSampler_( 0 )
{
...
bool ColorInversionDemo::LoadContent()
{
	...
	{
		DXTRACE_MSG( "±àÒëeffect shader Ê§°Ü£¡" );
		return false;
	}
