...
GameSpriteDemo::GameSpriteDemo() : solidColorVS_( 0 ) , solidColorPS_( 0 ) , inputLayout_( 0 ) ,
	vertexBuffer_( 0 ) , colorMap_( 0 ) , colorMapSampler_( 0 ) , alphaBlendState_( 0 ) , mvpCB_( 0 )
{
...
bool GameSpriteDemo::LoadContent()
{
	...
	{
		MessageBox( 0 , "¼ÓÔØ¶¥µã×ÅÉ«Æ÷Ê§°Ü£¡" , "±àÒë´íÎó£¡" , MB_OK );
		return false;
	}
	...
	if( compileResult == false )
	{
		MessageBox( 0 , "¼ÓÔØÏñËØ×ÅÉ«Æ÷Ê§°Ü£¡" , "±àÒë´íÎó£¡" , MB_OK );
		return false;
	}
